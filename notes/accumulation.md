...
It does **not** model the further consequences Marx draws from accumulation in *Capital* I, ch. 25: concentration and centralisation of capital, the rising organic composition of capital, or the reserve army of labour. It does not model reproduction schemas (*Capital* II, Departments I and II). Equalisation of profit rates and prices of production are modelled in [prices-of-production.md](prices-of-production.md). This increment isolates the compulsion to reinvest.
...
- Concentration and centralisation of capital, the rising organic composition of capital, and the reserve army of labour — the rest of *Capital* I, ch. 25.
- The tendency of the rate of profit to fall, and crises. How competition distributes surplus value *among* capitals (prices of production) is modelled in [prices-of-production.md](prices-of-production.md).
- The credit cycle and crises — how claims on future surplus value can outrun production (*Capital* III, Part 5). Interest-bearing capital is in [finance.md](finance.md); the titles themselves are in [fictitious-capital.md](fictitious-capital.md).
- Crises, as the point at which accumulation's own contradictions become manifest.
...
- *Capital* I, ch. 25 (Aveling) / ch. 25 §§4–5 (Fowkes) — the general law of capitalist accumulation (concentration, centralisation, reserve army) — referenced here as deferred, not modelled.
